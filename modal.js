...
function initModal(tabs) {
  ...
  modal_footer.innerHTML = `
    <button id="tabsurlSaveTxt" class="tabsurlBtn">Save text</button>
    <button id="tabsurlSaveStorage" class="tabsurlBtn">Save storage</button>
    <button id="tabsurlOpenStored" class="tabsurlBtn">Open stored</button>
  `;
